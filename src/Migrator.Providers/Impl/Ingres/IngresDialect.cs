...
namespace Migrator.Providers.Impl.Ingres
{
    public class IngresDialect : Dialect
    {
        ...
        {
            return new IngresTransformationProvider(dialect, connectionString, scope, providerName);
        }
        ...
        {
            return new IngresTransformationProvider(dialect, connection, scope, providerName);
        }
    }
}